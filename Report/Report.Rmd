...
![](../images/dae.png)
\begin{center}
FIG1: The clusters obtained by a deep autoencoder. On the left the colors are based on the true labels which are different cell types. On the right we show that partition an independent k-means clustering gave in order to assess the success of our dimension reduction.
\end{center}
...
![](../images/bvae.png)
\begin{center}
FIG2: The clusters obtained by a beta-VAE. The k-means clustering algorithm did partly detect 7/9 cell clusters. 
\end{center}
...
![](../images/bvsc.png)
\begin{center}
FIG3: The clusters obtained by a beta-VSC.
\end{center}
...
![](../images/perf.png){width=250px}
\begin{center}
FIG4: Heatmap of performance scores of each models. We computed four different measures.
\end{center}
...
Our study showed that the traditional deep autoencoder works very well and despite of its simplicity, it can elegantly capture the most important and informative components and help us to reduce the dimensions for visualization. We started with over 13 000 genes as features and managed to build a bottle neck of only six components. With the help of the reduced latent space and a 2D representation of it by t-SNE, we visualized the distinctive clusters and found almost all the cell groups.

Variational autoencoders are definitely more complex but for our purposes they did not perform better than the deep autoencoder. JATKUU
