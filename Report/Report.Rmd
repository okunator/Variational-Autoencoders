...
Our study showed that the traditional deep autoencoder works very well and despite of its simplicity, it can elegantly capture the most important and informative components and help us to reduce the dimensions for visualization. We started with over 13000 genes as features and managed to build a bottle neck of only six components. With the help of the reduced latent space and a 2D representation of it by t-SNE, we visualized the distinctive clusters  
